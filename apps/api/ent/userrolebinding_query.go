...
func (_q *UserRoleBindingQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(userrolebinding.Table, userrolebinding.FieldID, selector),
...
func (_q *UserRoleBindingQuery) QueryRole() *RoleQuery {
...
func (_q *UserRoleBindingQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserRoleBindingQuery) FirstIDX(ctx context.Context) string {
...
func (_q *UserRoleBindingQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserRoleBindingQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *UserRoleBindingQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *UserRoleBindingQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserRoleBindingQuery) WithUser(opts ...func(*UserQuery)) *UserRoleBindingQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *UserRoleBindingQuery) WithRole(opts ...func(*RoleQuery)) *UserRoleBindingQuery {
	query := (&RoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(userrolebinding.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserRoleBinding.Query().
//		Select(userrolebinding.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *UserRoleBindingQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserRoleBinding, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserRoleBinding, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRole; query != nil {
		if err := _q.loadRole(ctx, query, nodes, nil,
			func(n *UserRoleBinding, e *Role) { n.Edges.Role = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserRoleBindingQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserRoleBinding, init func(*UserRoleBinding), assign func(*UserRoleBinding, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*UserRoleBinding)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *UserRoleBindingQuery) loadRole(ctx context.Context, query *RoleQuery, nodes []*UserRoleBinding, init func(*UserRoleBinding), assign func(*UserRoleBinding, *Role)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*UserRoleBinding)
	for i := range nodes {
		fk := nodes[i].RoleID
...
func (_q *UserRoleBindingQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userrolebinding.Table, userrolebinding.Columns, sqlgraph.NewFieldSpec(userrolebinding.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(userrolebinding.FieldUserID)
		}
		if _q.withRole != nil {
			_spec.Node.AddColumnOnce(userrolebinding.FieldRoleID)
		}
	}
