...
func (_u *RoleUpdate) AddUserBindingIDs(ids ...string) *RoleUpdate {
	_u.mutation.AddUserBindingIDs(ids...)
	return _u
}

// AddUserBindings adds the "user_bindings" edges to the UserRoleBinding entity.
func (_u *RoleUpdate) AddUserBindings(v ...*UserRoleBinding) *RoleUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddUserBindingIDs(ids...)
}
...
// ClearUserBindings clears all "user_bindings" edges to the UserRoleBinding entity.
func (_u *RoleUpdate) ClearUserBindings() *RoleUpdate {
	_u.mutation.ClearUserBindings()
	return _u
}

// RemoveUserBindingIDs removes the "user_bindings" edge to UserRoleBinding entities by IDs.
func (_u *RoleUpdate) RemoveUserBindingIDs(ids ...string) *RoleUpdate {
	_u.mutation.RemoveUserBindingIDs(ids...)
	return _u
}

// RemoveUserBindings removes "user_bindings" edges to UserRoleBinding entities.
func (_u *RoleUpdate) RemoveUserBindings(v ...*UserRoleBinding) *RoleUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveUserBindingIDs(ids...)
}
...
func (_u *RoleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.UserBindingsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.UserBindingsTable,
			Columns: []string{role.UserBindingsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedUserBindingsIDs(); len(nodes) > 0 && !_u.mutation.UserBindingsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.UserBindingsTable,
	...
	if nodes := _u.mutation.UserBindingsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.UserBindingsTable,
...
// AddUserBindingIDs adds the "user_bindings" edge to the UserRoleBinding entity by IDs.
func (_u *RoleUpdateOne) AddUserBindingIDs(ids ...string) *RoleUpdateOne {
	_u.mutation.AddUserBindingIDs(ids...)
	return _u
}

// AddUserBindings adds the "user_bindings" edges to the UserRoleBinding entity.
func (_u *RoleUpdateOne) AddUserBindings(v ...*UserRoleBinding) *RoleUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearUserBindings clears all "user_bindings" edges to the UserRoleBinding entity.
func (_u *RoleUpdateOne) ClearUserBindings() *RoleUpdateOne {
	_u.mutation.ClearUserBindings()
	return _u
}

// RemoveUserBindingIDs removes the "user_bindings" edge to UserRoleBinding entities by IDs.
func (_u *RoleUpdateOne) RemoveUserBindingIDs(ids ...string) *RoleUpdateOne {
	_u.mutation.RemoveUserBindingIDs(ids...)
	return _u
}

// RemoveUserBindings removes "user_bindings" edges to UserRoleBinding entities.
func (_u *RoleUpdateOne) RemoveUserBindings(v ...*UserRoleBinding) *RoleUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
