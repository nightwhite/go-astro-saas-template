...
func (_c *SystemSettingCreate) SetTenantID(v string) *SystemSettingCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *SystemSettingCreate) SetNillableTenantID(v *string) *SystemSettingCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *SystemSettingCreate) SetUpdatedBy(v uuid.UUID) *SystemSettingCreate {
	_c.mutation.SetUpdatedBy(v)
	return _c
}

// SetNillableUpdatedBy sets the "updated_by" field if the given value is not nil.
func (_c *SystemSettingCreate) SetNillableUpdatedBy(v *uuid.UUID) *SystemSettingCreate {
	if v != nil {
		_c.SetUpdatedBy(*v)
	}
	return _c
...
func (_c *SystemSettingCreate) defaults() {
	if _, ok := _c.mutation.TenantID(); !ok {
		v := systemsetting.DefaultTenantID
		_c.mutation.SetTenantID(v)
	}
...
func (_c *SystemSettingCreate) check() error {
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`ent: missing required field "SystemSetting.tenant_id"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *SystemSettingCreate) createSpec() (*SystemSetting, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantID(); ok {
		_spec.SetField(systemsetting.FieldTenantID, field.TypeString, value)
