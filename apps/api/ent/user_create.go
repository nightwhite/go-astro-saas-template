...
func (_c *UserCreate) SetProfileFileID(v uuid.UUID) *UserCreate {
	_c.mutation.SetProfileFileID(v)
	return _c
}

// SetNillableProfileFileID sets the "profile_file_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableProfileFileID(v *uuid.UUID) *UserCreate {
	if v != nil {
		_c.SetProfileFileID(*v)
	}
	return _c
}
...
func (_c *UserCreate) AddPasskeyCredentialIDs(ids ...string) *UserCreate {
...
func (_c *UserCreate) AddUploadedFileIDs(ids ...string) *UserCreate {
	_c.mutation.AddUploadedFileIDs(ids...)
	return _c
}

// AddUploadedFiles adds the "uploaded_files" edges to the File entity.
func (_c *UserCreate) AddUploadedFiles(v ...*File) *UserCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddRoleBindings(v ...*UserRoleBinding) *UserCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddTeamMembershipIDs(ids ...string) *UserCreate {
...
func (_c *UserCreate) AddAgentConversationIDs(ids ...string) *UserCreate {
	_c.mutation.AddAgentConversationIDs(ids...)
	return _c
}

// AddAgentConversations adds the "agent_conversations" edges to the AgentConversation entity.
func (_c *UserCreate) AddAgentConversations(v ...*AgentConversation) *UserCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddAgentConversationIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ProfileFileID(); ok {
		_spec.SetField(user.FieldProfileFileID, field.TypeUUID, value)
		_node.ProfileFileID = &value
	}
	...
	if nodes := _c.mutation.AgentConversationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
