...
func (_c *RolePermissionCreate) SetDescription(v string) *RolePermissionCreate {
	_c.mutation.SetDescription(v)
	return _c
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (_c *RolePermissionCreate) SetNillableDescription(v *string) *RolePermissionCreate {
	if v != nil {
		_c.SetDescription(*v)
	}
	return _c
...
func (_c *RolePermissionCreate) defaults() {
	...
	if _, ok := _c.mutation.Description(); !ok {
		v := rolepermission.DefaultDescription
		_c.mutation.SetDescription(v)
	}
...
func (_c *RolePermissionCreate) check() error {
	...
	if _, ok := _c.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`ent: missing required field "RolePermission.description"`)}
	}
