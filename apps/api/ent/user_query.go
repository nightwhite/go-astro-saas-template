...
type UserQuery struct {
	...
	withUploadedFiles      *FileQuery
	withRoleBindings       *UserRoleBindingQuery
	withTeamMemberships    *TeamMembershipQuery
	withAgentConversations *AgentConversationQuery
...
func (_q *UserQuery) QueryUploadedFiles() *FileQuery {
...
func (_q *UserQuery) QueryRoleBindings() *UserRoleBindingQuery {
	query := (&UserRoleBindingClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryAgentConversations chains the current query on the "agent_conversations" edge.
func (_q *UserQuery) QueryAgentConversations() *AgentConversationQuery {
	query := (&AgentConversationClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withAgentConversations: _q.withAgentConversations.Clone(),
...
func (_q *UserQuery) WithUploadedFiles(opts ...func(*FileQuery)) *UserQuery {
	query := (&FileClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithRoleBindings(opts ...func(*UserRoleBindingQuery)) *UserQuery {
	query := (&UserRoleBindingClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithAgentConversations tells the query-builder to eager-load the nodes that are connected to
// the "agent_conversations" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithAgentConversations(opts ...func(*AgentConversationQuery)) *UserQuery {
	query := (&AgentConversationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAgentConversations = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withUploadedFiles; query != nil {
		if err := _q.loadUploadedFiles(ctx, query, nodes,
			func(n *User) { n.Edges.UploadedFiles = []*File{} },
			func(n *User, e *File) { n.Edges.UploadedFiles = append(n.Edges.UploadedFiles, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRoleBindings; query != nil {
		if err := _q.loadRoleBindings(ctx, query, nodes,
			func(n *User) { n.Edges.RoleBindings = []*UserRoleBinding{} },
			func(n *User, e *UserRoleBinding) { n.Edges.RoleBindings = append(n.Edges.RoleBindings, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withAgentConversations; query != nil {
		if err := _q.loadAgentConversations(ctx, query, nodes,
			func(n *User) { n.Edges.AgentConversations = []*AgentConversation{} },
			func(n *User, e *AgentConversation) {
				n.Edges.AgentConversations = append(n.Edges.AgentConversations, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadUploadedFiles(ctx context.Context, query *FileQuery, nodes []*User, init func(*User), assign func(*User, *File)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *UserQuery) loadRoleBindings(ctx context.Context, query *UserRoleBindingQuery, nodes []*User, init func(*User), assign func(*User, *UserRoleBinding)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userrolebinding.FieldUserID)
	}
	query.Where(predicate.UserRoleBinding(func(s *sql.Selector) {
...
func (_q *UserQuery) loadAgentConversations(ctx context.Context, query *AgentConversationQuery, nodes []*User, init func(*User), assign func(*User, *AgentConversation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(agentconversation.FieldUserID)
	}
	query.Where(predicate.AgentConversation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.AgentConversationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
