...
const ShinyButton = motion.button as unknown as React.ForwardRefExoticComponent<
  ShinyButtonProps & React.RefAttributes<HTMLButtonElement>
>;

export default function ShinyButtonComponent({ children, className, ...props }: ShinyButtonProps) {
  return (
    <ShinyButton
      className={cn(
